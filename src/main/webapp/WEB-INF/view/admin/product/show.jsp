                        ...
                        <div class="page-container">
                            <div class="container-fluid">
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                                    <div>
                                        <h1 class="h3 mb-1">Danh sách Product</h1>
                                ...
                                <div class="card border-0 shadow-sm">
                                    <div class="card-header bg-transparent">
                                        <i class="fas fa-users me-2 text-primary"></i> Tất cả sản phẩm
                                    </div>
                                    <div class="card-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="btn-group" role="group"
                                                                    aria-label="Actions">
                                                                    <a href="/admin/product/view/${p.id}"
                                                                    ...
                                                                    <form method="post" action="/admin/product/delete"
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            title="Xóa"
                                                                            onclick="return confirm('Bạn có chắc chắn muốn xóa product #${p.id}?');">
