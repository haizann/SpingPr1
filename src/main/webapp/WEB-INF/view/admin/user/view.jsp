                ...
                <div class="page-container">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                <h1 class="h3 mb-1">Chi tiết User</h1>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-2 text-secondary small">Email</div>
                                        <div class="fw-semibold">
                                            <c:out value="${user.email}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2 text-secondary small">Số điện thoại</div>
                                        <div class="fw-semibold">
                                            <c:out value="${user.phone}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-2 text-secondary small">Họ và tên</div>
                                        <div class="fw-semibold">
                                            <c:out value="${user.fullName}" />
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2 text-secondary small">Địa chỉ</div>
                                        <div class="fw-semibold">
                                    ...
                                    <!-- Role -->
                                    <div class="col-md-6">
                                        <div class="mb-2 text-secondary small">Role</div>
                                        <div class="fw-semibold">
                                    ...
                                    <!-- Avatar -->
                                    <div class="col-md-6">
                                        <div class="mb-2 text-secondary small">Avatar</div>
                                        <div>
                                            <c:choose>
